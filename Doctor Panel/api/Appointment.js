...
function getAllProduct() {
    ...
    $.ajax({
        method: "POST",
        url: "http://localhost:8081/api/v1/appoinment/consultant-name/"+userName,
        async: true,
...
// Add click event listeners to the buttons
  // Add click event listener for "Edit" button
    ...
    editButton.click(function () {
        ...
        $.ajax({
            url: "http://localhost:8081/api/v1/appoinment/appointments/" + appointmentId + "/approve",
            type: "POST",
...
deleteButton.click(function () {
    ...
    var appointmentId = element.id; // Assuming element.id contains the appointment ID
    $.ajax({
        url: "http://localhost:8081/api/v1/appoinment/appointments/" + appointmentId + "/reject",
        type: "POST",
        success: function(response) {
