...
function saveEmp() {
    ...
    $.ajax({
        ...
        url: "http://localhost:8081/api/v1/consult/saveconsult",
        async: true,
        data: JSON.stringify({
            id: "",
            name: name,
...
function updateEmp() { 
    ...
    $.ajax({
        method: "PUT",
        contentType: "application/json",
        url: "http://localhost:8081/api/v1/consult/getconsult/"+id,
        async: true,
        data: JSON.stringify({
            id: "",
            name: name,
...
function getAllProduct() {
    $.ajax({
        method: "GET",
        url: "http://localhost:8081/api/v1/consult/getconsult",
        async: true,
        success: function (data) {
            populateTable(data);
        },
